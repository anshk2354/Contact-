...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a>,\n\n✨ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴍxᴍᴏᴅᴇʀ ᴘʀᴇᴍɪᴜᴍ ʙᴏᴛ! ✨\nᴀᴀ ɢᴀʏᴇ ʜᴏ ᴏᴜs ᴅᴜɴɪʏᴀ ᴍᴇɪɴ ᴊᴀʜᴀɴ ʜᴀʀ ᴀᴘᴘ ᴍɪʟᴛᴀ ʜᴀɪ ғʀᴇᴇ ᴀᴜʀ ʙɪɴᴀ ᴊʜᴀɴᴊʜᴀᴛ ᴋᴇ!\n\nᴀɢᴀʀ ʙᴏᴛ ᴏᴡɴᴇʀ sᴇ ᴄᴏɴᴛᴀᴄᴛ ᴋᴀʀɴᴀ ʜᴀɪ ᴛᴏɴ 👇\n📞 ᴛʏᴘᴇ ᴋᴀʀᴏ: ᴀᴘɴᴀ ᴍᴇssᴀɢᴇ\n\n(𝟸𝟺/𝟽 ᴀᴠᴀɪʟᴀʙʟᴇ – ᴋᴀʙʜɪ ʙʜɪ, ᴋᴀʜɪ ʙʜɪ!)<b>"""
